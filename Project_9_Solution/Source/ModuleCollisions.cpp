...
ModuleCollisions::ModuleCollisions(bool startEnabled) : Module(startEnabled)
{
	...
	matrix[Collider::Type::ENEMY_SHOT][Collider::Type::FLAME] = false;
	matrix[Collider::Type::ENEMY_SHOT][Collider::Type::GRENADE] = false;
	...
	matrix[Collider::Type::ITEM][Collider::Type::FLAME] = false;
	matrix[Collider::Type::ITEM][Collider::Type::GRENADE] = false;
}
